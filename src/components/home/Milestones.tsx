          ...
          {milestones.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                className={`${theme === 'dark' ? 'bg-zinc-900 border-white/5' : 'bg-white border-black/5'} p-8 rounded-slight shadow-m3-1 dark:shadow-none transition-all duration-300 hover:shadow-m3-2 dark:hover:shadow-uiupc-orange/10 hover:-translate-y-1 group border`}
              >
                <div className="flex items-center gap-4 mb-6">
                  <div className="text-uiupc-orange transition-transform duration-500 group-hover:scale-110">
                ...
                <div className="space-y-1">
                  <h3 className={`font-black uppercase tracking-wider text-[11px] ${theme === 'dark' ? 'text-white' : 'text-zinc-900'}`}>
                    {item.label}
                  </h3>
