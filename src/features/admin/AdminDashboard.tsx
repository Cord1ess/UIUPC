...
const MembershipApplications = dynamic(() => import("@/components/MembershipApplications"), {
  loading: () => <Loading />,
  ssr: false,
});
const PhotoSubmissions = dynamic(() => import("@/components/PhotoSubmissions"), {
  loading: () => <Loading />,
  ssr: false,
});
        ...
        <div className="admin-content">
          ...
          {dataType === "results" ? (
            ...
            <>
              ...
              <PhotoSubmissions data={data || []} loading={loading} searchTerm={searchTerm} filterStatus={filterStatus} onSearchChange={setSearchTerm} onFilterChange={setFilterStatus} onRefresh={fetchData} onExport={exportData} onViewDetails={handleViewDetails} onEmailReply={handleEmailReply} connectionTest={connectionTest} />
            </>
          ) : dataType === "gallery" ? (
